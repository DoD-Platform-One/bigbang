...
| alloy.enabled | bool | `false` | Toggle deployment of grafana alloy |
...
| addons.headlamp.git.tag | string | `"0.30.1-bb.1"` |  |
...
| addons.headlamp.helmRepo.tag | string | `"0.30.1-bb.1"` |  |
