...
![Version: 3.10.0](https://img.shields.io/badge/Version-3.10.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| prometheusOperatorCRDs.git.tag | string | `"23.0.0-bb.0"` |  |
...
| prometheusOperatorCRDs.helmRepo.tag | string | `"23.0.0-bb.0"` |  |
...
| addons.mattermostOperator.git.tag | string | `"1.25.2-bb.1"` |  |
...
| addons.mattermostOperator.helmRepo.tag | string | `"1.25.2-bb.1"` |  |
...
| addons.headlamp.git.tag | string | `"0.36.0-bb.5"` |  |
...
| addons.headlamp.helmRepo.tag | string | `"0.36.0-bb.5"` |  |
