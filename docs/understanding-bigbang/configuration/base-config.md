...
| addons.externalSecrets.git.tag | string | `"0.13.0-bb.1"` |  |
...
| addons.externalSecrets.helmRepo.tag | string | `"0.13.0-bb.1"` |  |
...
| addons.mimir.git.tag | string | `"5.5.1-bb.4"` |  |
...
| addons.mimir.helmRepo.tag | string | `"5.5.1-bb.4"` |  |
