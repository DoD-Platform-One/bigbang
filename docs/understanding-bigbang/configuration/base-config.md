...
![Version: 2.29.0](https://img.shields.io/badge/Version-2.29.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| Andrew Schoell | a.shoell@wearemetronome.com |  |
...
| addons.nexusRepositoryManager.git.tag | string | `"68.1.0-bb.0"` |  |
...
| addons.nexusRepositoryManager.helmRepo.tag | string | `"68.1.0-bb.0"` |  |
...
| addons.mattermostOperator.git.tag | string | `"1.21.0-bb.1"` |  |
...
| addons.mattermostOperator.helmRepo.tag | string | `"1.21.0-bb.1"` |  |
...
| addons.harbor.git.tag | string | `"1.14.2-bb.6"` |  |
...
| addons.harbor.helmRepo.tag | string | `"1.14.2-bb.6"` |  |
...
| addons.holocron.git.tag | string | `"1.0.9"` |  |
...
| addons.holocron.helmRepo.tag | string | `"1.0.9"` |  |
...
| addons.thanos.git.tag | string | `"15.4.3-bb.0"` |  |
...
| addons.thanos.helmRepo.tag | string | `"15.4.3-bb.0"` |  |
...
| wrapper | object | `{"git":{"path":"chart","repo":"https://repo1.dso.mil/big-bang/product/packages/wrapper.git","tag":"0.4.8"},"helmRepo":{"chartName":"wrapper","repoName":"registry1","tag":"0.4.8"},"sourceType":"git"}` | Wrapper chart for integrating Big Bang components alongside a package |
...
| wrapper.helmRepo.tag | string | `"0.4.8"` | Tag of the OCI chart in `repo` |
...
| wrapper.git.tag | string | `"0.4.8"` | Git tag to check out.  Takes precedence over branch. [More info](https://fluxcd.io/flux/components/source/gitrepositories/#reference), example: 0.0.2 |
