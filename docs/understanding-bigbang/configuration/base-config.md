...
| addons.harbor.git.tag | string | `"1.13.1-bb.3"` |  |
...
| addons.harbor.helmRepo.tag | string | `"1.13.1-bb.3"` |  |
...
| addons.thanos.git.tag | string | `"12.13.12-bb.4"` |  |
...
| addons.thanos.helmRepo.tag | string | `"12.13.12-bb.4"` |  |
