...
| istio.git.tag | string | `"1.13.5-bb.2"` |  |
...
| monitoring.git.tag | string | `"36.2.1-bb.2"` |  |
...
| addons.argocd.git.tag | string | `"4.9.12-bb.2"` |  |
...
| addons.anchore.git.tag | string | `"1.18.6-bb.9"` |  |
