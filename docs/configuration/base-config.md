...
![Version: 3.32.0](https://img.shields.io/badge/Version-3.32.0-informational?style=flat-square)  ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| addons.vault | object | `{"enabled":false,"flux":{"driftDetection":{"ignore":[{"paths":[""],"target":{"kind":"MutatingWebhookConfiguration"}},{"paths":[""],"target":{"kind":"Job"}},{"paths":[""],"target":{"kind":"StatefulSet"}}]}},"git":{"path":"./chart","repo":"https://repo1.dso.mil/big-bang/product/packages/vault.git","tag":"0.34.1-bb.0"},"helmRepo":{"chartName":"vault","repoName":"registry1","tag":"0.34.1-bb.0"},"ingress":{"cert":"","gateway":"","key":""},"postRenderers":[],"sourceType":"git","values":{}}` | Vault package configuration. |
