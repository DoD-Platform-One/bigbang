...
| addons.anchoreEnterprise.git.tag | string | `"3.21.3-bb.1"` |  |
...
| addons.anchoreEnterprise.helmRepo.tag | string | `"3.21.3-bb.1"` |  |
...
| addons.mimir.git.tag | string | `"5.8.0-bb.5"` |  |
...
| addons.mimir.helmRepo.tag | string | `"5.8.0-bb.5"` |  |
