...
![Version: 3.14.0](https://img.shields.io/badge/Version-3.14.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| networkPolicies | object | `{"controlPlaneCidr":"0.0.0.0/0","egress":{"definitions":{"sso":{"to":[{"ipBlock":{"cidr":"0.0.0.0/0"}}]},"storage-subnets":{"ports":[{"port":443,"protocol":"TCP"}],"to":[{"ipBlock":{"cidr":"0.0.0.0/0"}}]}}},"enabled":true,"ingress":{"definitions":{"load-balancer-subnets":{"from":[{"ipBlock":{"cidr":"192.168.0.0/16"}},{"ipBlock":{"cidr":"172.16.0.0/12"}},{"ipBlock":{"cidr":"10.0.0.0/8"}}]}}},"nodeCidr":"","vpcCidr":"0.0.0.0/0"}` | Global NetworkPolicies settings |
...
| networkPolicies.egress.definitions | object | `{"sso":{"to":[{"ipBlock":{"cidr":"0.0.0.0/0"}}]},"storage-subnets":{"ports":[{"port":443,"protocol":"TCP"}],"to":[{"ipBlock":{"cidr":"0.0.0.0/0"}}]}}` | Egress definitions; create definitions here that you want to re-use globally across all packages |
...
| prometheusOperatorCRDs.git.tag | string | `"25.0.1-bb.0"` |  |
...
| prometheusOperatorCRDs.helmRepo.tag | string | `"25.0.1-bb.0"` |  |
...
| addons.nexusRepositoryManager.git.tag | string | `"86.0.0-bb.0"` |  |
...
| addons.nexusRepositoryManager.helmRepo.tag | string | `"86.0.0-bb.0"` |  |
...
| addons.anchoreEnterprise.git.tag | string | `"3.14.2-bb.4"` |  |
...
| addons.anchoreEnterprise.helmRepo.tag | string | `"3.14.2-bb.4"` |  |
...
| addons.mattermostOperator.git.tag | string | `"1.25.3-bb.0"` |  |
...
| addons.mattermostOperator.helmRepo.tag | string | `"1.25.3-bb.0"` |  |
...
| addons.harbor.git.tag | string | `"1.18.0-bb.6"` |  |
...
| addons.harbor.helmRepo.tag | string | `"1.18.0-bb.6"` |  |
...
| addons.thanos.git.tag | string | `"17.3.3-bb.1"` |  |
...
| addons.thanos.helmRepo.tag | string | `"17.3.3-bb.1"` |  |
...
| addons.externalSecrets.git.tag | string | `"0.20.4-bb.0"` |  |
...
| addons.externalSecrets.helmRepo.tag | string | `"0.20.4-bb.0"` |  |
...
| addons.mimir.git.tag | string | `"5.8.0-bb.4"` |  |
...
| addons.mimir.helmRepo.tag | string | `"5.8.0-bb.4"` |  |
...
| addons.headlamp.git.tag | string | `"0.39.0-bb.1"` |  |
...
| addons.headlamp.helmRepo.tag | string | `"0.39.0-bb.1"` |  |
...
| packages | object | `{"sample":{"configMaps":{},"dependsOn":[],"enabled":false,"flux":{},"git":{"branch":null,"commit":null,"credentials":{"caFile":"","knownHosts":"","password":"","privateKey":"","publicKey":"","username":""},"existingSecret":"","path":null,"repo":null,"semver":null,"tag":null},"helmRepo":{"chartName":null,"repoName":null,"tag":null},"istio":{},"kustomize":false,"monitor":{},"network":{},"passBigBangValues":true,"postRenderers":[],"secrets":{},"sourceType":"git","values":{},"wrapper":{"enabled":false,"postRenderers":[]}}}` | Packages to deploy with Big Bang @default - '{}' |
