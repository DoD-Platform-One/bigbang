...
| istioCNI.git.repo | string | `"https://repo1.dso.mil/big-bang/product/packages/istio-cni.git"` |  |
| istioCNI.git.path | string | `"./chart"` |  |
| istioCNI.git.tag | string | `"1.30.3-bb.0"` |  |
| istioCNI.helmRepo.repoName | string | `"registry1"` |  |
| istioCNI.helmRepo.chartName | string | `"istio-cni"` |  |
| istioCNI.helmRepo.tag | string | `"1.30.3-bb.0"` |  |
...
| istioGateway.flux.driftDetection.ignore[0].paths[0] | string | `""` |  |
| istioGateway.flux.driftDetection.ignore[0].target.kind | string | `"PeerAuthentication"` |  |
| istioGateway.flux.driftDetection.ignore[0].target.namespace | string | `"istio-gateway"` |  |
| istioGateway.flux.driftDetection.ignore[1].paths[0] | string | `""` |  |
| istioGateway.flux.driftDetection.ignore[1].target.kind | string | `"AuthorizationPolicy"` |  |
| istioGateway.flux.driftDetection.ignore[1].target.namespace | string | `"istio-gateway"` |  |
| istioGateway.flux.driftDetection.ignore[2].paths[0] | string | `""` |  |
| istioGateway.flux.driftDetection.ignore[2].target.kind | string | `"NetworkPolicy"` |  |
| istioGateway.flux.driftDetection.ignore[2].target.namespace | string | `"istio-gateway"` |  |
...
| prometheusOperatorCRDs.git.tag | string | `"31.0.1-bb.0"` |  |
...
| prometheusOperatorCRDs.helmRepo.tag | string | `"31.0.1-bb.0"` |  |
...
| bbctl.repoCredentials.email | string | `""` |  |
| bbctl.registryOverrides | list | `[]` |  |
| bbctl.preflightCheck.image | string | `""` |  |
...
| addons.anchoreEnterprise.git.tag | string | `"3.25.1-bb.1"` |  |
...
| addons.anchoreEnterprise.helmRepo.tag | string | `"3.25.1-bb.1"` |  |
...
| addons.mattermostOperator.git.tag | string | `"1.25.7-bb.3"` |  |
...
| addons.mattermostOperator.helmRepo.tag | string | `"1.25.7-bb.3"` |  |
...
| addons.harbor.git.tag | string | `"1.19.2-bb.0"` |  |
...
| addons.harbor.helmRepo.tag | string | `"1.19.2-bb.0"` |  |
...
| addons.thanos.git.tag | string | `"17.4.0-bb.3"` |  |
...
| addons.thanos.helmRepo.tag | string | `"17.4.0-bb.3"` |  |
...
| addons.externalSecrets.git.tag | string | `"2.8.0-bb.0"` |  |
...
| addons.externalSecrets.helmRepo.tag | string | `"2.8.0-bb.0"` |  |
...
| addons.mimir.git.tag | string | `"6.1.0-bb.1"` |  |
...
| addons.mimir.helmRepo.tag | string | `"6.1.0-bb.1"` |  |
...
| addons.headlamp.git.tag | string | `"0.44.0-bb.0"` |  |
...
| addons.headlamp.helmRepo.tag | string | `"0.44.0-bb.0"` |  |
...
| packages | object | `{"sample":{"bbCommonValues":true,"configMaps":{},"dependsOn":[],"enabled":false,"flux":{},"git":{"branch":null,"commit":null,"credentials":{"caFile":"","knownHosts":"","password":"","privateKey":"","publicKey":"","username":""},"existingSecret":"","path":null,"repo":null,"semver":null,"tag":null},"helmRepo":{"chartName":null,"repoName":null,"tag":null},"includeDefaultDependsOn":true,"istio":{},"kustomize":false,"monitor":{},"namespace":{},"network":{},"passBigBangValues":false,"postRenderers":[],"secrets":{},"sourceType":"git","values":{},"wrapper":{"enabled":false,"postRenderers":[]}}}` | Packages to deploy with Big Bang @default - '{}' |
