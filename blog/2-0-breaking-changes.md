...
Provided you make the above adjustments you will be able to deploy with the same set of packages you were using in 1.x. Example values for each of the above are provided in a reference file [here](https://repo1.dso.mil/big-bang/bigbang/-/blob/2.0.0/docs/assets/configs/example/core-packages-1-x.yaml).
