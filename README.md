...
| twistlock.git.tag | string | `"0.0.3-bb.0"` |  |
...
| addons.argocd.git.tag | string | `"2.14.7-bb.0"` |  |
...
| addons.anchore.git.tag | string | `"1.12.4-bb.0"` |  |
...
| addons.mattermostoperator.git.tag | string | `"1.12.0-bb.0"` |  |
...
| addons.mattermost.git.tag | string | `"0.1.0-bb.2"` |  |
