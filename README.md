...
| kiali.git.tag | string | `"1.36.0-bb.3"` |  |
...
| clusterAuditor.git.tag | string | `"0.3.0-bb.4"` |  |
...
| logging.git.tag | string | `"0.1.17-bb.0"` |  |
...
| eckoperator.git.tag | string | `"1.6.0-bb.1"` |  |
...
| addons.velero.git.tag | string | `"2.23.3-bb.0"` |  |
