...
| fluentbit.git.tag | string | `"0.16.6-bb.0"` |  |
...
| addons.minioOperator.git.tag | string | `"4.2.3-bb.1"` |  |
...
| addons.minio.git.tag | string | `"4.2.3-bb.1"` |  |
...
| addons.mattermost.git.tag | string | `"0.2.0-bb.2"` |  |
