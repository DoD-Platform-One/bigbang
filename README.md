...
![Version: 1.1.0-bb.7](https://img.shields.io/badge/Version-1.1.0--bb.7-informational?style=flat-square) ![AppVersion: 1.1.0](https://img.shields.io/badge/AppVersion-1.1.0-informational?style=flat-square)
...
| waitforready.image | object | `{"repository":"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl","tag":"1.27.3"}` | Image to use in wait for ready job.  This must contain kubectl. |
