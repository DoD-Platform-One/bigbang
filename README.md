...
| promtail | object | `{"enabled":false,"flux":{},"git":{"path":"./chart","repo":"https://repo1.dso.mil/platform-one/big-bang/apps/sandbox/promtail.git","tag":"3.8.1-bb.1"},"postRenderers":[],"values":{}}` | BETA support of promtail/loki logging stack |
